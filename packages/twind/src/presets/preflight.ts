...
const preflight: Preflight = {
  ...
  html: {
    ...
    MozTabSize: '4' /* 3 */,
    tabSize: 4 /* 3 */,
    fontFamily: `theme(fontFamily.sans, ${(baseTheme.fontFamily as Record<string, string>).sans})` /* 4 */,
    fontFeatureSettings: 'theme(fontFamily.sans[1].fontFeatureSettings, normal)' /* 5 */,
  },
  body: {
    margin: '0' /* 1 */,
    fontSize: `theme(fontSize.base[0], ${baseTheme.fontSize.base[0]})`,
    lineHeight: `theme(fontSize.base[1], ${baseTheme.fontSize.base[1]})`,
  },
